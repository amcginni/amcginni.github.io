/* Define WMS server for each layer */
...
/* This puts the coordinates and zoom level in the URL*/
...
var map = L.map('map', {
 ...
 /* TODO: make .setContent xhtml conformant.
 const popup = L.popup();
 function onMapClick(e) {
  popup
   .setLatLng(e.latlng)
   .setContent(`<div><a href="https://www.google.com/maps?layer=c&amp;cbll=${e.latlng.lat},${e.latlng.lng}">Google Street View</a><br/>
    <a href="https://www.bing.com/maps/?cp=${e.latlng.lat}~${e.latlng.lng}&amp;style=x">Bing Street Side</a></div>`)
   .openOn(map);
 };
...
/* Add the Layers button to the map */
