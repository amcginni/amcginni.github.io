    ...
    L.MeasureAction = L.Handler.extend({
        ...
        _getDistanceString: function (distance) {
            return distance < 5280
                ...
                : this._numberFormat(distance / 5280, L.Measure.kilometerDecimals) + " " + L.Measure.kilometer; //Miles, not km
        },

        _getDistance: function (latlng1, latlng2) {
            var earthRadius = 20925647; // radius of the earth in feet
        ...
        _getAreaString: function (points) {
            ...
            return Math.round(a) < 27878788 //1 sq. mi = 27878788 sq. ft
                ? this._numberFormat(a, L.Measure.squareMeterDecimals) + " " + L.Measure.squareMeter
                : this._numberFormat(a / 27878788, L.Measure.squareKilometersDecimals) + " " + L.Measure.squareKilometers;
        },
